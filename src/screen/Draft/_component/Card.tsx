  ...
  return (
    <View
      ...
      <View style={styles.row}>
       ...
       {element.creditorAmount && <Text style={styles.value}>{element.creditorAmount},00 руб</Text>}
       {element.debtorAmount && <Text style={styles.value}>{element.debtorAmount},00 руб</Text>}
       {element.phones[0] && <Text style={styles.value}>{element.phones[0]}13123123</Text>}
       {element.emails[0] && <Text style={styles.value}>{element.emails[0]}123123123</Text>}
       {element.actualAddress && <Text style={styles.value}>{element.actualAddress}dasdasdasdasd</Text>}
       {element.addressTT && <Text style={styles.value}>{element.addressTT}asdasdasdasd</Text>}
       {element.localAddress && <Text style={styles.value}>{element.localAddress}asdasdasd</Text>}
       {element.warehouseAddress && <Text style={styles.value}>{element.warehouseAddress}asdasdasd</Text>}
      </View>
      {/* <View style={styles.row}>
